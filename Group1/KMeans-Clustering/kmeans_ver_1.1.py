# -*- coding: utf-8 -*-
"""
Created on Sat Oct 19 17:32:16 2019
...
img = ax.scatter(X[:,0],X[:,1],X[:, 2], c=kmeans.labels_, s = 12, cmap='rainbow')
img1 = ax.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1],kmeans.cluster_centers_[:, 2], s=150, color='black')
